package com.speculatingwook.OauthSpringBoot.domain.login.oauth.handler;
...
import static com.speculatingwook.OauthSpringBoot.domain.login.oauth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
import static com.speculatingwook.OauthSpringBoot.domain.login.oauth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REFRESH_TOKEN;
